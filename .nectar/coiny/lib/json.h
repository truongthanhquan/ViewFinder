...
__NJS_DECL_FUNCTION<__NJS_VAR (vector<var>)>* __NJS_FN___hcmd9s = new __NJS_DECL_FUNCTION<__NJS_VAR (vector<var>)>([]( vector<var> __NJS_VARARGS ) -> __NJS_VAR{var __json; if(__NJS_VARARGS.size() > 0) __json = __NJS_VARARGS[0];
	...
	free(tok);
	return __RESULT;
;return __NJS_Create_Undefined();});var __NJS_JSON_PARSE=__NJS_VAR(__NJS_FUNCTION, __NJS_FN___hcmd9s);;


__NJS_DECL_FUNCTION<__NJS_VAR (vector<var>)>* __NJS_FN___4b3sk = new __NJS_DECL_FUNCTION<__NJS_VAR (vector<var>)>([]( vector<var> __NJS_VARARGS ) -> __NJS_VAR{var __object; if(__NJS_VARARGS.size() > 0) __object = __NJS_VARARGS[0];
	return __NJS_Object_Stringify(__object);
;return __NJS_Create_Undefined();});var __NJS_JSON_STRINGIFY=__NJS_VAR(__NJS_FUNCTION, __NJS_FN___4b3sk);;
